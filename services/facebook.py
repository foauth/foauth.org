...
class Facebook(foauth.proviers.Oauth2):
    ...
    signature_location = foauth.providers.SIGN_QUERYSTRING
    ...
    available_permissions = {
        ...
        'friends_activities': "access your friends' favoriate activities",
        'friends_birthday': "access your friends' birthdays",
